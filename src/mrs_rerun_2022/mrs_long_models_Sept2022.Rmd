...
write.csv(acg_dat, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/acg_data_molal_outliers_removed_n112_Oct2022.csv", row.names = FALSE)
```
LAG
```{r}
...
write.csv(lag_dat, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/lag_data_molal_outliers_removed_n318_Octt2022.csv", row.names = FALSE)
```
...
#write to csv
write.csv(acg_metab_desc, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/acg_metab_descriptives_Oct2022.csv")
...
#write to csv
write.csv(lag_metab_desc, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_metab_descriptives_n318_Oct2022.csv")
...
ggsave(plot=acc_naa, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/acg_naa_age_oct2022.png")
...
ggsave(plot=acc_cho,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/acg_cho_age_oct2022.png")
...
acc_ins<-ggplot(acg_dat, aes(x=mri_age_y, y=Ins_conc_molal,color=as.factor(female))) + 
  ...
  labs(x = "Age (years)", y = "Ins (mmol/kg)") +
  scale_color_viridis(name = "Sex", labels = c("Male", "Female"), discrete = TRUE, option = "H", begin = .2, end = .8) +
...
acc_ins
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/acg_ins_age_oct2022.png")
...
acc_fig
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/manuscript/figures/acc_naa_cho_ins_age_fig_oct2022.png", acc_fig, width = 3000, height = 1500, units = "px")
```
...
write.csv(fdr_table_lag_new, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/fdr_table_lag_oct2022.csv")
```
...
lag_naa<-ggplot(lag_dat_plot, aes(x=mri_age_y, y=lag_naa_partial, na.exclude = TRUE, color=as.factor(female))) +
  ...
  theme(legend.position='none')
lag_naa
ggsave(plot=lag_naa,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_naa_age_tf_oct2022.png")
...
lag_cre<-ggplot(lag_dat_plot_Cre, aes(x=mri_age_y, y=lag_cre_partial, na.exclude = TRUE, color=as.factor(female))) +
  ...
  theme(legend.position = c(.9,.95), legend.title = element_blank(),legend.background = element_blank(), legend.box.background = element_rect(colour = "black"), legend.text = element_text(size=8), legend.key.height = unit(.3, 'cm'), legend.key.width=unit(.3, 'cm'), legend.spacing.y = unit(0, "pt"))
lag_cre
ggsave(plot=lag_cre,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_cre_age_tf_oct2022.png")
...
lag_cho<-ggplot(lag_dat_plot_cho, aes(x=mri_age_y, y=lag_cho_partial, na.exclude = TRUE, color=as.factor(female))) +
  ...
  theme(legend.position = 'none')
lag_cho
ggsave(plot=lag_cho,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_cho_age_tf_oct2022.png")

library(patchwork)
lag_fig<-lag_naa + lag_cho + lag_cre + plot_layout(nrow=1) 
lag_fig
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/manuscript/figures/lag_fig_oct2022.png", lag_fig, width = 3000, height = 1500, units = "px")
...
```{r}
#read data
lag_dat<-read.csv("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/lag_data_molal_outliers_removed_n318_Oct2022.csv")
...
write.csv(lag_dat_long, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/lag_data_3plus_visits_Oct2022.csv")
...
write.csv(lag_long_desc,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_long_metab_means_oct2022.csv")
...
write.csv(fdr_table_long_age, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/fdr_table_long_age_oct2022.csv")
...
write.csv(fdr_table_quad_age2, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/fdr_table_quad_age_oct2022.csv")
...
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_naa_long_age_oct2022.png", plot=plot_lag_naa_tf_long)
...
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_cho_long_quad_octt2022.png", plot=plot_lag_cho_tf_quad)
...
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_cre_long_oct2022.png", plot=plot_lag_cre_tf_long)
...
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_glx_long_quad_octt2022.png", plot=plot_lag_glx_tf_quad)
...
lag_long_fig
ggsave("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/manuscript/figures/results_lag_long_n51_oct2022.png", lag_long_fig, width = 2000, height = 2000, units = "px")
...
write.csv(acg_pct.df,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/acg_pct_chg_oct2022.csv", row.names=FALSE)
...
write.csv(lag_pct.df,"/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/results/lag_pct_chg_oct2022.csv", row.names=FALSE)
...
```{r}
acg_dat<- read.csv("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/acg_data_molal_outliers_removed_n112_Oct2022.csv")
