...
```{r}
acg_lcm <- read.csv("/Volumes/catherine_team/mvperdue/preschool/mrs/data_acg/Output_12-Sep-2022/ACG_LCM_CorrectedTable_09-12-2022-10-39.csv")
...
acg_qc<-read.csv("/Volumes/catherine_team/mvperdue/preschool/mrs/data_acg/SE_PRESS_QC_Metrics_acg.csv")

acg_dat<-left_join(acg_dat, acg_qc, by = "File_ID")

write.csv(acg_dat, "/Volumes/catherine_team/mvperdue/preschool/mrs/data_acg/Output_12-Sep-2022/acg_data_molal_n114.csv", row.names = FALSE)

lag_lcm <- read.csv("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/Output_16-Sep-2022/LAG_LCM_CorrectedTable_09-16-2022-11-19.csv")
...
write.csv(lag_dat, "/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/Output_16-Sep-2022/lag_data_molal_n320.csv", row.names = FALSE)
