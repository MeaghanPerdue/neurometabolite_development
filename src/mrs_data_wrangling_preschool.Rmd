...
mrs_lag['pfile_path'].to_csv("/Users/meaghan/OneDrive - University of Calgary/Preschool_data/MRS/data/mrs_lag_pfile_dir.txt", sep ='\t', header=False, index=False)
```
